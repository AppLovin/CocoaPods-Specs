...
s.source = 
{
  :http => 'https://applovin-mobile-artifacts.s3.amazonaws.com/ios/com/applovin/applovin-sdk/beta/applovin-ios-sdk-10.2.1-beta3.zip',
  :type => 'zip'
}
s.vendored_frameworks = 'applovin-ios-sdk-10.2.1-beta3/AppLovinSDK.framework'
s.module_map = 'applovin-ios-sdk-10.2.1-beta3/AppLovinSDK.framework/Modules/module.modulemap'
s.preserve_paths = 'applovin-ios-sdk-10.2.1-beta3/appledoc/*'
s.resource = 'applovin-ios-sdk-10.2.1-beta3/AppLovinSDKResources.bundle'
