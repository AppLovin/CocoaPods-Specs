...
s.source = 
{
  :http => 'https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/beta/applovin-ios-sdk-11.4.1-beta1.zip',
  :type => 'zip'
}
s.vendored_frameworks = 'applovin-ios-sdk-11.4.1-beta1/AppLovinSDK.xcframework'
s.preserve_paths = 'applovin-ios-sdk-11.4.1-beta1/appledoc/*'
s.resource = 'applovin-ios-sdk-11.4.1-beta1/AppLovinSDKResources.bundle'
