...
s.source = 
{ 
  :http => 'https://bintray.com/applovin/PythonLib/download_file?file_path=applovin-ios-sdk-7.0.0-beta12.zip',
  :type => 'zip'
}
s.vendored_frameworks = 'applovin-ios-sdk-7.0.0-beta12/AppLovinSDK.framework'
s.module_map = 'applovin-ios-sdk-7.0.0-beta12/AppLovinSDK.framework/Modules/module.modulemap'
s.preserve_paths = 'applovin-ios-sdk-7.0.0-beta12/appledoc/*'
s.resource = 'applovin-ios-sdk-7.0.0-beta12/AppLovinSDKResources.bundle'
