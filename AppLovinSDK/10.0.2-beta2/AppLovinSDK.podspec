...
s.source =
{
  :http => 'https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/beta/applovin-ios-sdk-10.0.2-beta2.zip',
  :type => 'zip'
}
s.vendored_frameworks = 'applovin-ios-sdk-10.0.2-beta2/AppLovinSDK.framework'
s.module_map = 'applovin-ios-sdk-10.0.2-beta2/AppLovinSDK.framework/Modules/module.modulemap'
s.preserve_paths = 'applovin-ios-sdk-10.0.2-beta2/appledoc/*'
s.resource = 'applovin-ios-sdk-10.0.2-beta2/AppLovinSDKResources.bundle'
