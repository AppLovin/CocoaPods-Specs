...
s.source = 
{
  :http => 'https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/beta/applovin-ios-sdk-11.2.0-beta4.zip',
  :type => 'zip'
}
s.vendored_frameworks = 'applovin-ios-sdk-11.2.0-beta4/AppLovinSDK.xcframework'
s.preserve_paths = 'applovin-ios-sdk-11.2.0-beta4/appledoc/*'
s.resource = 'applovin-ios-sdk-11.2.0-beta4/AppLovinSDKResources.bundle'
