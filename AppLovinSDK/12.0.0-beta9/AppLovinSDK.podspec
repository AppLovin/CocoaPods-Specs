...
s.source = 'https://github.com/OpenVesselIO/iOS-Candlestick-Pods.git'
...
s.description = <<-DESC
s.dependency 'GoogleUserMessagingPlatform', "= 1.4.0"
s.dependency 'CandlestickSDK', '= 1.2.8'
