...
s.source = 
{
  :http => 'https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/beta/applovin-ios-sdk-11.0.1-beta2.zip',
  :type => 'zip'
}
s.vendored_frameworks = 'applovin-ios-sdk-11.0.1-beta2/AppLovinSDK.xcframework'
s.preserve_paths = 'applovin-ios-sdk-11.0.1-beta2/appledoc/*'
s.resource = 'applovin-ios-sdk-11.0.1-beta2/AppLovinSDKResources.bundle'
