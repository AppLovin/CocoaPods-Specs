...
s.source = 
{
  :http => "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/beta/applovin-ios-sdk-#{s.version}.zip",
  :type => "zip"
}
s.vendored_frameworks = "applovin-ios-sdk-#{s.version}/AppLovinSDK.xcframework"
s.preserve_paths = "applovin-ios-sdk-#{s.version}/appledoc/*"
