...
s.source = 
{
  :http => 'https://artifacts.applovin.com/ios/com/applovin/applovin-user-engagement-sdk/beta/applovin-ios-user-engagement-sdk-1.0.0-beta5.zip',
  :type => 'zip'
}

s.vendored_frameworks = 'applovin-ios-user-engagement-sdk-1.0.0-beta5/AppLovinUserEngagementSDK.xcframework'
s.preserve_paths = 'applovin-ios-user-engagement-1.0.0-beta5/appledoc/*'
s.resource = 'applovin-ios-user-engagement-1.0.0-beta5/AppLovinUserEngagementSDKResources.bundle'
